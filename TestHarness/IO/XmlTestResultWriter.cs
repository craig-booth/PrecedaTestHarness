...
{
    public class XmlTestResultWriter : ITestSuiteResultWriter
    {
        ...
        private void SaveTestItem(XmlElement xml, ITestItem testItem)
        {
        ...
        private void SaveTestGroup(XmlElement xml, TestGroup testGroup)
        {
        ...
        private void SaveUnitTest(XmlElement xml, UnitTest unitTest)
        {
        ...
        private void SaveTestCase(XmlElement xml, TestCase testCase)
        {
